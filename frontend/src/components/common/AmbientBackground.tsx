...
export const AmbientBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const themeParticleColors: Record<string, string[]> = {
      ...
      sunset: ['rgba(225, 48, 108, 0.35)', 'rgba(247, 119, 55, 0.3)', 'rgba(131, 58, 180, 0.25)'],
      instagram: ['rgba(225, 48, 108, 0.35)', 'rgba(247, 119, 55, 0.3)', 'rgba(131, 58, 180, 0.25)'],
      emerald: ['rgba(37, 211, 102, 0.35)', 'rgba(18, 140, 126, 0.28)', 'rgba(0, 168, 132, 0.25)'],
      whatsapp: ['rgba(37, 211, 102, 0.35)', 'rgba(18, 140, 126, 0.28)', 'rgba(0, 168, 132, 0.25)'],
